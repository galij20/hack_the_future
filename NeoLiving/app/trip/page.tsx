            ...
            <Card className="w-full max-w-2xl bg-white/90 backdrop-blur-sm shadow-lg border border-gray-200">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input
                    placeholder="e.g., Pokhara, Butwal"
                    value={destination}
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-sm text-gray-600">
                    Enter your total budget for the entire trip in Nepalese Rupees
                  </p>
                </div>
              </CardContent>
              <CardFooter>
                    ...
                    {hotel.imageUrl && (
                      <div className="relative h-48 w-full">
                        <img
                          ...
                          onError={(e) => {
                            e.currentTarget.src = "https://images.unsplash.com/photo-1496417263034-38ec4f0b665a?q=80&w=1000" // Generic hotel placeholder
                          }}
                        />
                  ...
                  <Card key={trip.id} className="flex flex-col bg-white/90 backdrop-blur-sm shadow-lg border border-gray-200">
                    ...
                    <CardContent className="flex-grow">
                      <div className="space-y-2">
                        ...
                        <p className="text-gray-600">
                          <span className="font-medium">Cost:</span> ₨ {trip.cost.toLocaleString('ne-NP')}
                        </p>
                        {trip.rating && (
