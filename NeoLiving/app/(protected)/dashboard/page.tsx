...
import { WalletCards, Plane, Home as HomeIcon, Plus, ArrowRight, Calendar, Bell, ChartBar, Settings, Search, BarChart2, ChevronLeft, ChevronRight } from "lucide-react"
    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-6 md:grid-cols-3">
        ...
        <QuickActionCard
          ...
          href="/trip"
          stats={[
            { label: "Next Trip", value: "Bandipur" },
            { label: "In", value: "12 days" }
          ]}
        />
        <QuickActionCard
